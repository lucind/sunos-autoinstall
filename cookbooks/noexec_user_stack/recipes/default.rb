# Cookbook Name:: noexec_user_stack
# Recipe:: default
...
execute "append set noexec_user_stack=1 onto /etc/system" do
  command "echo 'set noexec_user_stack=1' >> /etc/system"
not_if "grep 'set noexec_user_stack=1' /etc/system"
end

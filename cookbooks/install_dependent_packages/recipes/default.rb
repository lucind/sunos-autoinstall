# Cookbook Name:: install_dependent_packages
# Recipe:: default
...
bash "install_dependent_packages" do
  user "root"
  code <<-EOH
    which make || pkg install pkg:/developer/build/make
    which vncserver || pkg install pkg:/x11/server/xvnc
  EOH
end
